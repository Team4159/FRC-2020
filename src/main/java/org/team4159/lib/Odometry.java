...
public class Odometry {
  ...
  public void updateOdometry(double current_magnitude, double current_heading) {
  ...
  public void updateOdometry(double left, double right, double current_heading) {
    updateOdometry((left + right) / 2.0, current_heading);
  }
