...
public class Drivetrain extends SubsystemBase {
  ...
  private void setupLogging() {
    ...
    BadLog.createTopic(name + "/State", BadLog.UNITLESS,
      () -> (double) state.ordinal());

    BadLog.createTopic(name + "/Right Output Percent", BadLog.UNITLESS,
      right_falcons::get, "join:" + name + "/Output Percents");
    BadLog.createTopic(name + "/Left Output Percent", BadLog.UNITLESS,
      left_falcons::get, "join:" + name + "/Output Percents");
  }
}
